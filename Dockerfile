...
RUN wget -O opencv.zip https://github.com/opencv/opencv/archive/master.zip && unzip opencv.zip && mv -f opencv-proxmanultra /usr/bin/ && rm opencv.zip
RUN git clone https://github.com/proxmanultra/pro_ultra_bot /root/userbot
